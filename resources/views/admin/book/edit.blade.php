                            ...
                            <div class="card-body">
                                <div id="example1_wrapper" class="dataTables_wrapper dt-bootstrap4">
                                    <div class="row">
                                        <!-- form input -->
                                        <div class="col-sm-12">
                                            <form class="form-row" action="{{route('book.update',$book->id)}}" method="post"
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <input name="license_no" type="text" class="form-control" value="{{$book->license_no}}">
                                                    {{--                                                    @error('license_no')--}}
                                                    {{--                                                    <p class="text-danger">{{ $message }}</p>--}}
                                                    {{--                                                    @enderror--}}
                                                </div>
                                                <div class="form-group col-6">
                                                    ...
                                                    <input name="lang" type="text" class="form-control" value="{{$book->lang}}">
                                                    {{--                                                    @error('lang')--}}
                                                    {{--                                                    <p class="text-danger">{{ $message }}</p>--}}
                                                    {{--                                                    @enderror--}}
                                                </div>
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <input name="republish_no" type="text" class="form-control" value="{{$book->republish_no}}">
                                                    {{--                                                    @error('republish_no')--}}
                                                    {{--                                                    <p class="text-danger">{{ $message }}</p>--}}
                                                    {{--                                                    @enderror--}}
                                                </div>
                                                ...
                                                <div class="form-group col-6">
                                                    ...
                                                    <input name="qty" type="text" class="form-control" value="{{$book->qty}}">
                                                    {{--                                                    @error('qty')--}}
                                                    {{--                                                    <p class="text-danger">{{ $message }}</p>--}}
                                                    {{--                                                    @enderror--}}
                                                </div>
